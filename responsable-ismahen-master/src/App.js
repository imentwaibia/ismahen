...
import AjoutProduit from "./pages/magasin/ajoutProduit";
import Facture from "./pages/magasin/facture";
import ListCommande from "./pages/magasin/list-commnades";
import ListProduit from "./pages/magasin/listProduit";
import ListeCategorie from "./pages/magasin/categorie/listCategorie";
import AjoutCommande from "./pages/magasin/commande/ajout-commande";
  ...
  if (token) {
    ...
    routes = (
      <React.Fragment>
        ...
        <Route path="/list-commande" exact component={ListCommande} />
        <Route path="/listProduit" exact component={ListProduit} />
        <Route path="/categorie" exact component={ListeCategorie} />
        <Route path="/ajout-commande" exact component={AjoutCommande} />
